...
def create_first_window(title=None, theme="DarkTeal6"):    
    ...
    layout = [
        [
            ...
            sg.Input("", (50, None), key="-NAME-"),
        ],
        [
            sg.Text("Data de Nascimento:"),
            sg.In(size=(35,None), key="-BIRTHDAY-"),
            sg.CalendarButton("Selecionar", format="%d/%m/%Y"), # y minusculo so pega o dois ultimos digitos, Y pega 4
        ],
        [
        ...
        [
            sg.Text("Progresso:"),
            sg.ProgressBar(3, size=(35, 25), bar_color="green on lightgrey", key="-PROGRESS-"),
        ]
    ]
